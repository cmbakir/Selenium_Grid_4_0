...
public class DriverFactory {
    ...
    private static WebDriver getLocalDriver(String browser) {
        ...
        switch (browser.toLowerCase()) {
            case "chrome":
                System.setProperty("webdriver.chrome.driver", "src/test/GRID/browsers/chromedriver");
            ...
            case "firefox":
                System.setProperty("webdriver.gecko.driver", "browser eklemedım");
            ...
            case "edge":
                System.setProperty("webdriver.edge.driver", "src/test/GRID/browsers/msedgedriver");
            ...
            case "ie":
                System.setProperty("webdriver.ie.driver", "browser yuklmedım");
